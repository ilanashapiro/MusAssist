...
the MusAssist compiler writes out the music via these instructions.
...
MusAssist's supports templates for chords, cadences, harmonic sequences at the abstraction
level of the musical theoretical structures they define. 

Chords are specified by root note (defined as the fundamental note is),
...
Half diminished and third inversion options apply to seventh chords only. 
