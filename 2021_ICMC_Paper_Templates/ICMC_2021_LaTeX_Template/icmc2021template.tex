...
\subsection{Generating Notes in a Diatonic Scale}
...
\subsection{Chords and Arpeggios}
...
\subsection{Cadences}
A cadence is expanded to the lists of chords it comprises using the logic from Section \ref{sec:chord_expansion}.
...
\\\verb.generateTriadWithinScale. is thus called to generate the chords for the given cadence type based on MusAssist's cadence representations from \figref{table:cadences}. 
