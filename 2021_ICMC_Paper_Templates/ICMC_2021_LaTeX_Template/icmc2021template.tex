...
\textbf{scales} (major, natural/harm- onic/melodic minor, chromatic, and whole tone), 
...
All sequences are shown in major in this demonstration, but their minor counterparts are also supported. Each consists of fourteen distinct chords before repeating in the subsequent octave. 
\vspace{-2mm}
\begin{table}[h!]
...
The full breadth of MusAssist's syntax is demonstrated in \figref{fig:example_program_code}, and \figref{fig:example_program} presents the result of opening the compiled MusicXML code in MuseScore. 
