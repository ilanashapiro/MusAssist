...
scales (major, natural/ harmonic/melodic minor, chromatic, and whole tone), 
...
To handle inversions, recall that the generated chord (whether triad or seventh) starts out in root position. Let $n$ be the desired inversion value (0 for root, 1 for first inversion, 2 for second, and 3 or third). By incrementing the octaves of the first $n$ tones of the chord in root position, we obtain the correct inversion.
