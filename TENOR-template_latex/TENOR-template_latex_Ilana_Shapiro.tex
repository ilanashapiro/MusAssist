...
The era of music programming languages began in 1957 with Max Mathews' machine-dependent MUSIC-N languages at Bell Labs. The first of these languages, Music I, generated a single, equilateral, triangular waveform with identical rise and decay characteristics. It was capable of playing melody only; the user specified pitch, amplitude, and duration for individual notes. This evolved into Music II, which supported four independent voices of sound and a choice of 16 waveforms, and into Music III, which introduced the concept of the $unit$-$generator$, the building block for sound synthesis programming languages that corresponds to the functions of analog synthesizers. Music IV was a more computationally sophisticated version of Music III, and finally Music V was developed to be machine-independent, the first music programming language to be released into the world in 1966 \cite{mathews_1957}.
