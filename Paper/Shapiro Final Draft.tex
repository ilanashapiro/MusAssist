...
%--------------------------------------------------------------------------------------------------------------------------------------------------------
\subsection{Harmonic Sequence Types}
...
As the ADT demonstrates, the templates to expand are notes, chord templates, cadence, harmonic sequences, and labels. Each will be 
...
%--------------------------------------------------------------------------------------------------------------------------------------------------------
\subsection{Intermediate Instructions}
...
MusAssistAST.hs defines one additional ADT: \verb.data Instr.. This ADT is not included in the parse result, and is instead generated from the expansion of the templates in \verb.IntermediateInstr.. This will be discussed in \Cref{chap:ir}.

When writing the parser, it was important to order parser alternatives correctly due to the issue of overlapping prefixes of identifiers in the concrete syntax. For instance, consider the parser for expressions (i.e. that maps to the ADT \verb.data expr.)
