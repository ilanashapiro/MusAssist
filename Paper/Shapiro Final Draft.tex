...
This section gives an overview of MusicXML's syntax as pertains to translations from MusAssist. A full and more detailed reference of MusicXML's syntax can be found here: \\\href{https://www.w3.org/2021/06/musicxml40/}{https://www.w3.org/2021/06/musicxml40/}.

Throughout the section, words in all caps (e.g. DURATION) are parameters.

\subsection{Static Header Code Attributes}
\begin{verbatim}
<attributes>
