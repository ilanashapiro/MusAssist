...
These commands,  respectively, translate to the following when loaded into the MuseScore notation software:
...
These commands,  respectively, translate to the following when loaded into in MuseScore notation software.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{images/f7}
