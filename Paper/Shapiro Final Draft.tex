...
\noindent where \verb!*NOTENAME*!, \verb!*ACCIDENTAL*!, and \verb!*OCTAVE*! are taken from the same options as in \Cref{sec:notes}

\verb![*NOTENAME**ACCIDENTAL**OCTAVE*]! indicates an arbitrarily long list where each of the values have the form \verb!*NOTENAME**ACCIDENTAL**OCTAVE*!

Examples of MusAssist notes are \verb!([Bb5, Db5, C5] half)! and  \verb!([C##5, E5] half)!
